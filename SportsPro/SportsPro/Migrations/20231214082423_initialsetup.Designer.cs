...
namespace SportsPro.Migrations
{
    ...
    [Migration("20231214082423_initialsetup")]
            ...
            modelBuilder.Entity("SportsPro.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentID = 1,
                            CustomerID = 5,
                            DateOpened = new DateTime(2023, 12, 14, 2, 24, 23, 523, DateTimeKind.Local).AddTicks(3954),
                        ...
                        new
                        {
                            IncidentID = 2,
                            CustomerID = 2,
                            DateOpened = new DateTime(2023, 12, 14, 2, 24, 23, 523, DateTimeKind.Local).AddTicks(3959),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductID = 7,
                            TechnicianID = 1,
                        ...
                        new
                        {
                            IncidentID = 3,
                            CustomerID = 3,
                            DateOpened = new DateTime(2023, 12, 14, 2, 24, 23, 523, DateTimeKind.Local).AddTicks(3963),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductID = 1,
                            TechnicianID = 3,
                            Title = "Error launching program"
                        ...
                        new
                        {
                            IncidentID = 4,
                            CustomerID = 5,
                            DateOpened = new DateTime(2023, 12, 14, 2, 24, 23, 523, DateTimeKind.Local).AddTicks(3967),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductID = 4,
                            TechnicianID = 2,
            ...
            modelBuilder.Entity("SportsPro.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductCode = "TRNY10",
                            ReleaseDate = new DateTime(2023, 12, 14, 0, 0, 0, 0, DateTimeKind.Local),
                            YearlyPrice = 4.99m
                        },
                        new
                        {
